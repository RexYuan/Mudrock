...
B_Teacher::B_Teacher (const string& filename) :
m{Mana{}},
aig{Aig{filename}},
sw{m.newSw()}
{
...
void B_Teacher::unroll (size_t n)
{
...
B_Types::Feedback B_Teacher::consider (const vector<Face>& faces)
{
...
Bv B_Teacher::counterexample () const
{
...
const B_Types::Feedback& B_Teacher::check_state () const
{
    return state;
}
